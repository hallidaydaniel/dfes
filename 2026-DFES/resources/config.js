...
OI.ready(function(){
	...
	dfes = new FES({
		"options": {
			...
			"scale": "relative",
			"years": {
				"columns":["2024/25","2025/26","2026/27","2027/28","2028/29","2029/30","2030/31","2031/32","2032/33","2033/34","2034/35","2035/36","2036/37","2037/38","2038/39","2039/40","2040/41","2041/42","2042/43","2043/44","2044/45","2045/46","2046/47","2047/48","2048/49","2049/50"]
			},
			"files": {
			...
			"buildMap": function(){
				...
				if(el){
					...
					if(!el.querySelector('.placesearch')){
						...
						div.innerHTML = '<div class="placesearch leaflet-button"><button class="submit" href="#" title="Search" role="button" aria-label="Search"></button><form class="placeform layersearch pop-left" action="search" method="GET" autocomplete="off"><input class="place" id="search" name="place" value="" placeholder="Search for a named area" aria-label="Search for a named area" type="text" /><div class="searchresults" id="searchresults"></div></form></div>';
						el.appendChild(div);
